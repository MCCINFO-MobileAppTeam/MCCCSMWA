...
<div data-role="page" data-content-theme="a" id="csmwa">
	...
	<?php } else {
		...
		if (count($errors) === 0) {  
			...
			try {				
				$query = 'INSERT INTO appt_request(visit_num, first_name, last_name, email_addr, mcc_status, contact_method, phone, mtg_days, mtg_time, mtg_location, status) ' .
					'VALUES(:visit_num, :first_name, :last_name, :email_addr, :mcc_status, :contact_method, :phone, :mtg_days, :mtg_time, :mtg_location, :status)';
